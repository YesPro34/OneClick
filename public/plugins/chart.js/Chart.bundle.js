...
*/
        ...
        drawPoint: function(ctx, style, radius, x, y, rotation) {
            ...
            if (style && typeof style === "object") {
                ...
                if (
                    ...
                    ctx.rotate(rad);
                    ctx.drawImage(
                        style, -style.width / 2, -style.height / 2,
                        style.width,
                        style.height
                    );
                    ctx.restore();
    ...
    var core_animations = {
        ...
        advance: function() {
            ...
            while (i < animations.length) {
                ...
                helpers$1.callback(
                    animation.onAnimationProgress, [animation],
                    chart
                );

                if (animation.currentStep >= numSteps) {
                    helpers$1.callback(
                        animation.onAnimationComplete, [animation],
                        chart
                    );
                    chart.animating = false;
    ...
    helpers$1.extend(DatasetController.prototype, {
        ...
        _configure: function() {
            ...
            me._config = helpers$1.merge(
                Object.create(null), [me.chart.options.datasets[me._type], me.getDataset()], {
    ...
    core_defaults._set("doughnut", {
        ...
        legend: {
            ...
            onClick: function(e, legendItem) {
                ...
                for (
                    i = 0, ilen = (chart.data.datasets || []).length; i < ilen;
                    ++i
                ) {
        ...
        draw: function() {
            ...
            if (me._showLine) {
                ...
                helpers$1.canvas.clipArea(chart.ctx, {
                    ...
                    right: clip.right === false ?
                        canvas.width : area.right + clip.right,
                    top: clip.top === false ? 0 : area.top - clip.top,
                    bottom: clip.bottom === false ?
                        canvas.height : area.bottom + clip.bottom,
                });
        ...
        /** @lends Chart */
        {
            ...
            render: function(config) {
                ...
                var onComplete = function(animation) {
                    ...
                    helpers$1.callback(
                        animationOptions && animationOptions.onComplete, [animation],
                        me
                    );
                };
            ...
            transition: function(easingValue) {
                ...
                for (
                    var i = 0, ilen = (me.data.datasets || []).length; i < ilen;
                    ++i
                ) {
            ...
            getVisibleDatasetCount: function() {
                var count = 0;
                for (
                    var i = 0, ilen = this.data.datasets.length; i < ilen;
                    ++i
                ) {
            ...
            handleEvent: function(e) {
                ...
                helpers$1.callback(
                    options.onHover || options.hover.onHover, [e.native, me.active],
                    me
                );
            ...
            if (tickOpts.display && display) {
                ...
                if (isHorizontal) {
                    ...
                    var labelWidth = tickOpts.mirror ?
                        0 : // use lineSpace for consistency with horizontal axis
    ...
    function determineMajorUnit(unit) {
        for (
            var i = UNITS.indexOf(unit) + 1, ilen = UNITS.length; i < ilen;
            ++i
        ) {
    ...
    function generate(scale, min, max, capacity) {
        ...
        for (
            time = first; time < max; time = +adapter.add(time, stepSize, minor)
        ) {
            ticks.push(time);
        }

...
(function(global, factory) {
    ...
    const getCloseButton = () => elementByClass(swalClasses.close); // https://github.com/jkup/focusable/blob/master/.js
    ...
    const isModal = () => {
        return (!hasClass(document.body, swalClasses["toast-shown"]) &&
    ...
    const removeCustomClasses = (elem, params) => {
        toArray(elem.classList).forEach((className) => {
            if (!Object.values(swalClasses).includes(className) &&
            ...
            preDenyPromise
                .then((preDenyValue) => {
                    if (preDenyValue === false) {
                        ...
                        instance.closePopup({
                            isDenied: true,
                            value: typeof preDenyValue === "undefined" ?
                                value : preDenyValue,
                        });
                    }
                })
    ...
    const handleArrows = (key) => {
        ...
        if (![confirmButton, denyButton, cancelButton].includes(
    ...
    function enableButtons() {
        setButtonsDisabled(
            this, ["confirmButton", "denyButton", "cancelButton"],
            false
        );
    }

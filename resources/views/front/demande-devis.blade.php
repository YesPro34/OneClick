...
<title>Demande de devis à Marrakech-Oneclick</title>
    ...
    <div class="container">
        <div class="form-wrapper">
            ...
            <div class="contact-form">
                ...
                <form id="contact-form" action="{{ route('/devis-save') }}" method="post" enctype="multipart/form-data">
                    @csrf  
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-30">
                                <select style="width:100%; height:80px; border:none;" name="type_demande" class="form-select" aria-label="Default select example">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="contact-btn text-center">
                                <button class="btn theme-btn" >Envoyer <i class="fa-solid fa-arrow-right-long"></i></button>
                            </div>
                        </div>
                    </div>
                </form>

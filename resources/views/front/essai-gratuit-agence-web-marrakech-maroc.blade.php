                            ...
                            <nav id="mobile-menu">
                                <ul>
                                    ...
                                    <li><a href="/blog-agence-web-maroc">blog</a>
                                        ...
                                        <li class="active"><a href="/contact-agence-web-marrakech-maroc">contact</a></li>
                                </ul>
                            </nav>
                        </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-4">
                <div class="contact text-center mb-30">
                    ...
                    <h3>E-Mail</h3>
                    <p>
                        <a href="mailto:contact@oneclick.ma">contact@oneclick.ma</a>
                    </p>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4">
                <div class="contact text-center mb-30">
                    ...
                    <h3>Adresse</h3>
                    <p>Avenue My Abdellah, Résidence Youssef Bnou Tachfine, 3 ème étage, numéro 46, Marrakech (à coté de sup de co )</p>
                </div>
            </div>
            <div class="col-xl-4  col-lg-4 col-md-4 ">
                <div class="contact text-center mb-30">
            ...
            <div class="row align-items-center">
                <div class="col-xl-8 col-lg-8">
                    ...
                    <div class="section-title mb-55">
                        <p><span></span>Parlons de votre projet</p>
                        <h1>Essayez-gratuitement</h1>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-3 d-none d-xl-block ">
                    <div class="section-link mb-80 text-right">
                        <a class="btn theme-btn" href="tel:+212 66 34 37 77 0"><i class="fas fa-phone"></i> Nous Appeler</a>
                    </div>
                </div>
            </div>
            <div class="contact-form">
                <form id="contact-form" action="{{ route('essai.store') }}" method="post">
                    @csrf  
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-box  fa-building mb-30">
                        ...
                        <div class="col-lg-6">
                            <div class="form-box  fa-location-pin mb-30 ">
                                <input type="text" name="adresse" placeholder="Adresse">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-box phone-icon mb-30">
                                <input type="text" name="tel_entreprise" placeholder="Téléphone Entreprise">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div  class="form-box user-icon mb-30">
                        ...
                        <div class="col-lg-12"> 
                            <div class="contact-btn text-center">
                                <button class="btn theme-btn" type="submit">Envoyer <i class="fa-solid fa-arrow-right-long"></i></button>
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="map-area">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3396.357470319497!2d-8.018946385365668!3d31.65143844782632!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xdafee88692179ed%3A0xec1a6cb4d86d2902!2sCr%C3%A9ation%20Site%20Web%20Marrakech!5e0!3m2!1sfr!2sma!4v1652175910275!5m2!1sfr!2sma"

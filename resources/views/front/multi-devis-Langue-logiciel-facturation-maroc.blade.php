...
<title>Multi-devis-langue-logiciel-facturation-maroc-Marraech-Oneclick </title>
...
@endsection
   @section('content')
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="page-title page-title-white text-center">
                        <h2>Facturez partout dans le monde. Gérez vos factures en devises simplement. </h2>
                        <div class="breadcrumb-list">
                            <ul>
                                ...
                                <li>Multi-devis/multi-langue</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!-- page-title-area end -->
    <!--start paragraphe-->
    <div class="intro-stock">
        <h1 class="title-stock"> Factures Multi-devises : Créez vos devis et factures simple et efficace</h1>
        <h5 class="para-stock"> facturez dans des devises différentes est une chance d'étendre vos activité vers l'étranger.
        </h5>
    </div>
    <!--end paragraphe-->
    ...
    <!-- video-area start -->
    <div class="video-area pt-300 pb-90" style="background-image:url(img/bg/bg8.jpg)">
        <div class="container ">
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="agency-wrapper mb-30">
                        <div class="section-title">
                            ...
                            <p>Avec OneClick, gérez très facilement vos Factures multi-devises et multi-langues (anglais, français). Vous pouvez aussi gérer vos Devis, Bons de Commande et Commandes d’Achat.</p>
                        </div>
                        <div class="agency-button mt-30">
                            <a class="btn btn-yellow active" href="/contact-agence-web-marrakech-maroc">Contactez nous <i
										class="fa-solid fa-arrow-right-long"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 offset-xl-1 col-lg-6">
                    <div class="agency-video bounce-animate-deux mb-30">
                        <img src="img/bg/multi1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- start first paragraphe-->
    <div class="faq-area pt-120 pb-90">
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="faq-img stock-img2 bounce-animate-deux mb-30">
                        <img src="img/bg/multi2.png" alt="">
                    </div>
                </div>
                <div class="col-xl-6 offset-xl-1 col-lg-6">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            ...
                                            <p>Avec OneClick, la création de devis est extrêmement rapide</p>

                                            <br>

                                            <p>
                                                Etendez votre activité à l’étranger et facturez vos clients internationaux en toute simplicité grâce à OneClick ! La fonctionnalité multidevises vous permet de facturer vos clients dans des devises différentes.</p>
                                            <br>

                                            <p>Sélectionnez la devise souhaitée (ex. USD).</p>
                                            <br>
                                            <p>Le taux de change est récupéré automatiquement. vous pouvez aussi saisir un autre taux manuellement.</p>
                                            <br>
                                            <p>Complétez et envoyez votre facture en devise. Simple.</p>
                                        </ul>
    ...
    <!-- end first paragraphe-->
    <!-- start fichier devis1-->
    <div class="features-area  pb-90">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="features-wrapper mb-5 ml-1">
                        <div class="features-text-deux mb-5">
                            <h1>Factures, Devis, Commandes
                                <br><br></h1>
                            <p>Vous pouvez créer très facilement des offres commerciales pour proposer vos services ou produits:
                            </p>
                            <ul>
                                <li>
                                    <p><i class="far fa-check-circle" aria-hidden="true" style="margin:10px ;"></i>Devis</p>
                                </li>
                                <li>
                                    <p><i class="far fa-check-circle" aria-hidden="true" style="margin:10px ;"></i>Bon de Commande client</p>
                                </li>
                                <li>
                                    <p><i class="far fa-check-circle" aria-hidden="true" style="margin:10px ;"></i> Commandes d’Achat</p>
                                </li>
                            </ul>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="features-img-deux bounce-animate-deux  devis-img ">
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="agency-wrapper pl-70 mb-30">
                        <div class="section-title">
                            ...
                            <h1>A noter ci-dessous les mentions obligatoires pour toute facture en devis</h1>
                            <div class="section-img mb-15">
                                <img src="img/shape/section.png" alt="">

                            </div>
                            <p> <i class="fa-solid fa-check m-3 green"></i> La devise utilisée / le code ISO de la devise (USD, GBP, COP, JPY etc…). </p>
                            <p> <i class="fa-solid fa-check m-3 green"></i> Le taux de change préalablement accordé avec votre client.
                            </p>
                            <p> <i class="fa-solid fa-check m-3 green"></i>En comptabilité, la facture doit être intégrée en euros avec un taux de &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;conversion . </p>
                        </div>
                        <div class="agency-button mt-30">
    ...
    <section class="testim" id="testim">
        <div class="title-slider">
            <h1>IIls ont essayé OneClick, ils l'ont adoré !</h1>
        </div>
        ...
        <div class="wrap">
            ...
            <div class="cont" id="testim-content">
                ...
                <div class="active">
                    <div class="img"><img src="img/icon/p11.png"></div>
                    <h2>Julien Lacroix</h2>
                    <p>Je suis venue voir l'équipe Oneclick avec un projet détaillé et plein d'idées arrêtées ! Leur écoute et leurs nombreux conseils ont permis l'élaboration d'une stratégie de lancement de ma marque via un site ecommerce et une application
                        de gestion et les réseaux sociaux.<br> Résultat ? Beaucoup de ventes au lancement, mais pas seulement ! Nous les avons ensuite pérennisées via du SEO et de la création de contenus !</p>
                </div>

                <div>
                    <div class="img"><img src="img/icon/p22.jpg"></div>
                    <h2>Patrick Louisan</h2>
                    <p>Responsable Marketing d'une célèbre marque de sport, j'étais à la recherche d'une agence capable de dépoussiérer notre communication digitale via des dispositifs créatifs et innovants. Oneclick a su me convaincre avec une remise à
                        niveau de nos outils et surtout la définition d'une ligne directrice dans notre communication..</p>
                </div>

                <div>
                    <div class="img"><img src="img/icon/p33.jpg"></div>
                    <h2>Julien Lacroix</h2>
                    <p>Je suis venue voir l'équipe Oneclick avec un projet détaillé et plein d'idées arrêtées ! Leur écoute et leurs nombreux conseils ont permis l'élaboration d'une stratégie de lancement de ma marque via un site ecommerce et une application
                        de gestion et les réseaux sociaux.<br> Résultat ? Beaucoup de ventes au lancement, mais pas seulement ! Nous les avons ensuite pérennisées via du SEO et de la création de contenus !</p>
                </div>
                ...
                <div>
                    <div class="img"><img src="img/icon/p44.jpg"></div>
                    <h2>Patrick Louisan</h2>
                    <p>Responsable Marketing d'une célèbre marque de sport, j'étais à la recherche d'une agence capable de dépoussiérer notre communication digitale via des dispositifs créatifs et innovants. Oneclick a su me convaincre avec une remise à
                        niveau de nos outils et surtout la définition d'une ligne directrice dans notre communication..</p>
                </div>
                ...
                <div>
                    <div class="img"><img src="img/icon/p55.jpg"></div>
                    <h2>Julien Lacroix</h2>
                    <p>Je suis venue voir l'équipe Oneclick avec un projet détaillé et plein d'idées arrêtées ! Leur écoute et leurs nombreux conseils ont permis l'élaboration d'une stratégie de lancement de ma marque via un site ecommerce et une application
                        de gestion et les réseaux sociaux.<br> Résultat ? Beaucoup de ventes au lancement, mais pas seulement ! Nous les avons ensuite pérennisées via du SEO et de la création de contenus !</p>
                </div>

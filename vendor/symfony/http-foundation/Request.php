...
class Request
{
     ...
     *
     *  * http://localhost/.php         returns an empty string
     *  * http://localhost/.php/page    returns an empty string
     *  * http://localhost/web/.php     returns '/web'
     *  * http://localhost/we%20b/.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
